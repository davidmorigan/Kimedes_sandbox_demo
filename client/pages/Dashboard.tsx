      ...
      <div className="flex-1 p-8">
        ...
        {activeSection === 'Localització de Fuites' ? (
          ...
          <div>
            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-lg font-semibold text-gray-900">Llista de fuites detectades</h2>
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50 border-b">
                      <tr>
                        ...
                        <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">Dificultat</th>
                        <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">Valor (€)</th>
                        <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">Assignació</th>
                        <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">Data detecció</th>
                        <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">Status</th>
                        <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">MAPA</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-200">
                      {[
                        { id: 'Leakage Sant Carles', ratio: '12 L/s', difficulty: 'Alta', value: '€6,456', assignee: 'Toni', date: '25/06/2025', status: 'Resolent', statusColor: 'bg-yellow-100 text-yellow-800' },
                        { id: 'Leakage #4', ratio: '15 L/s', difficulty: 'Mitja', value: '€6,006', assignee: 'Alex', date: '25/06/2025', status: 'Resolent', statusColor: 'bg-yellow-100 text-yellow-800' },
                        ...
                        { id: 'Leakage #7', ratio: '20 L/s', difficulty: 'Alta', value: '€9,898', assignee: 'Toni', date: '25/06/2025', status: 'Resolent', statusColor: 'bg-yellow-100 text-yellow-800' },
                        ...
                        { id: 'Leakage #9', ratio: '20 L/s', difficulty: 'Baixa', value: '€2,189', assignee: 'Jordi', date: '25/07/2025', status: 'Resolent', statusColor: 'bg-yellow-100 text-yellow-800' },
                        ...
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3 text-sm text-gray-900">{leak.difficulty}</td>
                          <td className="px-4 py-3 text-sm text-gray-900">{leak.value}</td>
                          <td className="px-4 py-3 text-sm text-gray-900">{leak.assignee}</td>
                          <td className="px-4 py-3 text-sm text-gray-500">{leak.date}</td>
                          <td className="px-4 py-3">
                            <span className={`px-2 py-1 text-xs font-medium rounded-full ${leak.statusColor}`}>
                              {leak.status}
                            </span>
                          </td>
                          <td className="px-4 py-3">
                            <Button size="sm" className="bg-gray-800 hover:bg-gray-900 text-white text-xs">
                              Veure
                            </Button>
                          </td>
                        </tr>
